...
defmodule AWS.CertificateManager do
  ...
  permission to do so](acm-pca/latest/userguide/PcaPermissions.html). For
  more information, see [Testing Managed
  Renewal](acm/latest/userguide/manuel-renewal.html) in the ACM User Guide.
  """
